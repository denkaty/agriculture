using Agriculture.Inventory.Application.Items.Commands.CreateItem;
using Agriculture.Inventory.Application.Items.Commands.DeleteItemById;
using Agriculture.Inventory.Application.Items.Queries.GetItemById;
using Agriculture.Inventory.Application.Items.Queries.GetItems;
using Agriculture.Inventory.Contracts.Features.Items.Commands.CreateItem;
using Agriculture.Inventory.Contracts.Features.Items.Commands.DeleteItemById;
using Agriculture.Inventory.Contracts.Features.Items.Quries.GetItemById;
using Agriculture.Inventory.Contracts.Features.Items.Quries.GetItems;
...
namespace Agriculture.Inventory.Web.Features.Items.Controllers.v1
{
    [AllowAnonymous]
    [ApiController]
    [ApiVersion("1")]
